(function() {
  ...
  class EditorView {
    ...
    */
    static scrollIntoView(pos, options = {}) {
      var _a2, _b, _c, _d;
      return scrollIntoView$1.of(new ScrollTarget(typeof pos == "number" ? EditorSelection.cursor(pos) : pos, (_a2 = options.y) !== null && _a2 !== void 0 ? _a2 : "nearest", (_b = options.x) !== null && _b !== void 0 ? _b : "nearest", (_c = options.yMargin) !== null && _c !== void 0 ? _c : 5, (_d = options.xMargin) !== null && _d !== void 0 ? _d : 5));
    }
    /**
  ...
  const descendantOp = 135, Unit = 1, identifier$2 = 136, callee = 137, VariableName = 2, queryIdentifier = 138, queryVariableName = 3, QueryCallee = 4;
  const space$1 = [
    9,
    10,
    11,
  ...
  const autoCloseTags = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
    ...
    let closeTags = state.changeByRange((range) => {
      ...
      if (didType && text == ">" && after.name == "EndTag") {
        ...
        if (((_b = (_a2 = tag.parent) === null || _a2 === void 0 ? void 0 : _a2.lastChild) === null || _b === void 0 ? void 0 : _b.name) != "CloseTag" && (name2 = elementName(state.doc, tag.parent, head)) && !selfClosers.has(name2)) {
        ...
        let tag = after.parent;
        if (after.from == head - 2 && ((_c = tag.lastChild) === null || _c === void 0 ? void 0 : _c.name) != "CloseTag" && (name2 = elementName(state.doc, tag, head)) && !selfClosers.has(name2)) {
          let to2 = head + (state.doc.sliceString(head, head + 1) === ">" ? 1 : 0);
          let insert2 = `${name2}>`;
          return {
  ...
  (function() {
    function buildVscTheme(isDark) {
      ...
      const darkHighlight = syntaxHighlighting(HighlightStyle.define([
        { tag: tags$1.keyword, color: "#569cd6" },
        { tag: tags$1.string, color: "#ce9178" },
        { tag: tags$1.comment, color: "#6a9955", fontStyle: "italic" },
        { tag: tags$1.number, color: "#b5cea8" },
        { tag: tags$1.className, color: "#d7ba7d" },
        { tag: tags$1.tagName, color: "#4ec9b0" },
        { tag: tags$1.propertyName, color: "#9cdcfe" },
        { tag: tags$1.variableName, color: "#9cdcfe" },
        { tag: tags$1.attributeName, color: "#9cdcfe" },
        { tag: tags$1.attributeValue, color: "#ce9178" },
        { tag: tags$1.angleBracket, color: "#808080" },
        { tag: tags$1.unit, color: "#b5cea8" },
        { tag: tags$1.color, color: "#ce9178" },
        { tag: tags$1.bracket, color: "#ffd700" },
        { tag: tags$1.punctuation, color: "#d4d4d4" },
        { tag: tags$1.operator, color: "#d4d4d4" }
      ]));
      ...
      const lightHighlight = syntaxHighlighting(HighlightStyle.define([
        { tag: tags$1.keyword, color: "#0000ff" },
        { tag: tags$1.string, color: "#a31515" },
        { tag: tags$1.comment, color: "#008000", fontStyle: "italic" },
        { tag: tags$1.number, color: "#098658" },
        { tag: tags$1.tagName, color: "#800000" },
        { tag: tags$1.attributeName, color: "#ff0000" },
        { tag: tags$1.attributeValue, color: "#0000ff" },
        { tag: tags$1.propertyName, color: "#001080" },
        { tag: tags$1.angleBracket, color: "#800000" },
        { tag: tags$1.className, color: "#267f99" },
        { tag: tags$1.unit, color: "#098658" },
        { tag: tags$1.punctuation, color: "#000000" }
      ]));
    ...
    Statamic.booting(() => {
      Statamic.$components.register("code-editor-fieldtype", {
        ...
        setup(props, { emit }) {
          ...
          onMounted(() => {
            var _a2;
            const lang = ((_a2 = props.config) == null ? void 0 : _a2.language) || "html";
            const theme2 = buildVscTheme(detectDarkMode());
            const langExtension = lang === "css" ? css() : html({ autoCloseTags: true });
